...
RUN mkdir -p /usr/src/geonodeictc
...
COPY src /usr/src/geonodeictc/
WORKDIR /usr/src/geonodeictc
...
RUN chmod +x /usr/src/geonodeictc/tasks.py \
    && chmod +x /usr/src/geonodeictc/entrypoint.sh
...
# ENTRYPOINT /usr/src/geonodeictc/entrypoint.sh
